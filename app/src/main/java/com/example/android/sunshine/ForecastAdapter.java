...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private final int TODAY_ID = 335;
    private final int FUTURE_ID = 336;
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.dayWeather.setText(dateString);
        ...
        } else if (getItemViewType(position) == FUTURE_ID){
            weatherImageId = SunshineWeatherUtils
...
//      DONE (5) Add an ImageView for the weather icon
        ...
        ForecastAdapterViewHolder(View view) {
            ...
            dayWeather = (TextView) view.findViewById(R.id.dayTextView);
            weatherDescription = (TextView) view.findViewById(R.id.descTextView);
            highTemperature = (TextView) view.findViewById(R.id.highTempTextView);
            lowTemperature = (TextView) view.findViewById(R.id.lowTempTextView);

            weatherIcon = (ImageView) view.findViewById(R.id.weatherImgView);
